...
def run(screen, camera_manager):
    ...
    home_button_center = (50 + circle_radius,
                          SCREEN_SIZE[1] - 50 - circle_radius)
    ...
    while running:
        ...
        if transformed_landmarks:
            for hand_landmarks in transformed_landmarks:
                index_pos = (int(hand_landmarks[8][0]), int(
                    hand_landmarks[8][1]))  # INDEX_FINGER_TIP
        ...
        pygame.draw.circle(screen, NAVY_BLUE,
                           increase_button_center, circle_radius)
        pygame.draw.circle(screen, LIGHT_BLUE,
                           increase_button_center, circle_radius, 5)
        ...
        # Draw reset button
        pygame.draw.circle(screen, NAVY_BLUE,
                           reset_button_center, circle_radius)
        pygame.draw.circle(screen, LIGHT_BLUE,
                           reset_button_center, circle_radius, 5)
        ...
        # Draw home button
        pygame.draw.circle(screen, NAVY_BLUE,
                           home_button_center, circle_radius)
        pygame.draw.circle(screen, LIGHT_BLUE,
                           home_button_center, circle_radius, 5)
        ...
        count_rect = count_surface.get_rect(
            center=(SCREEN_SIZE[0] // 2, SCREEN_SIZE[1] // 2 - 400))
...
if __name__ == '__main__':
    # Assuming CameraManager is in the parent directory
